...
use AP2\Core\Request;
use AP2\Core\RouteCollection;
...
class Dispatcher
{
     ...
     * @param \AP2\Core\RouteCollection $routeCollection
     * @param \AP2\Core\Request $request
     */
    ...
    private function dispatch()
    {
        ...
        if (isset($this->routeList[$this->currentRequest->getRoute()])) {
            ...
            $controllerClass = "AP2\\Controllers\\" . $this->routeList[$this->currentRequest->getRoute()]["controller"];
